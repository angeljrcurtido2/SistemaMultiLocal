...
public class ProveedoresPagina
{
    public List<Proveedor> Filas    { get; init; } = new();
...
public static class ProveedoresDibujador
{
    ...
    // Código | Nombre / Razón Social | RUC | Teléfono | Ciudad
    // 80 + 285 + 130 + 130 + 162 = 787
    private static readonly int[]    Cw  = {  80, 285, 130, 130, 162 };
    private static readonly float[]  Cx  = { 20f, 100f, 385f, 515f, 645f };
    private static readonly string[] Hdr = { "Código", "Nombre / Razón Social", "RUC", "Teléfono", "Ciudad" };
    ...
    public static int ContarPaginas(ProveedoresPagina p)
    {
        ...
        int totalPages)
    {
        ...
        const string titulo = "LISTADO DE PROVEEDORES";
        ...
        var sub = string.IsNullOrEmpty(p.Filtro) ? "Todos los proveedores" : p.Filtro;
        ...
        for (int i = start; i < end; i++)
        {
            ...
            float ty1 = y + tyR;
            DC(g, f.CodigoProveedor,    0, ty1);
            DC(g, f.NombreProveedor,    1, ty1);
            DC(g, f.RucProveedor,       2, ty1);
            DC(g, f.TelefonoProveedor,  3, ty1);
            DC(g, f.CiudadProveedor,    4, ty1);
