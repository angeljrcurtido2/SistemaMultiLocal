...
public static class ArticulosStockPorLocalImpresora
{
    public static async Task ImprimirAsync(ArticulosStockPorLocalPagina p, Window? owner = null)
    {
        var doc = new PrintDocument { DocumentName = "Stock por Local" };
        ...
        if (esPdf)
        {
            ...
            var sfd = new Microsoft.Win32.SaveFileDialog
            {
                ...
                DefaultExt       = "pdf",
                FileName         = $"StockPorLocal_{DateTime.Now:yyyyMMdd_HHmm}",
        ...
        await Task.Run(() =>
        {
            ...
            doc.PrintPage += (_, e) =>
            {
                ...
                e.HasMorePages = ArticulosStockPorLocalDibujador.DibujarPagina(g, p, logo, ref filaOffset, pageNum, totalPages);
            };
    ...
    public static void Imprimir(ArticulosStockPorLocalPagina p, Window? owner = null)
